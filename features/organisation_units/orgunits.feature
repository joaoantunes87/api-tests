...
I want to be able to add and manage organisation units
    ...
    Background:
      ...
      Scenario: Assign a parent to an organsiation unit
        ...
        And I create a new organisation unit
      ...
      Scenario Outline: Define an end date for an organisation unit
        When I have created an organisation unit with an opening date as <openingDate>
        And I provide a closed date as <pastDate>
        Then I should receive an error message.
        Examples:
        | openingDate | pastDate |
        | 2015-01-31T00:00:00.000 | 2015-01-30T00:00:00.000 |
        | 2010-05-04T00:00:00.000 | 1970-02-25T00:00:00.000 |
      ...
      Scenario Outline: Define an end date for an organisation unit
        ...
        Then I should be informed that the organisation unit was updated.
        Examples:
        | openingDate | futureDate |
        | 2015-01-30T00:00:00.000 | 2015-01-31T00:00:00.000 |
        | 1970-02-25T00:00:00.000 | 2010-05-04T00:00:00.000 |
